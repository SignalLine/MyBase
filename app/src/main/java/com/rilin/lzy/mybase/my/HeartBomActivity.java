...
import com.rilin.lzy.mybase.util.ImageProcessing;
...
public class HeartBomActivity extends BaseActivity {

    //曲线,timer任务与timer一起使用
    ...
    //
    private static TextView text,text1,text2;
    ...
    public int setViewId() {
        return R.layout.activity_heart_bom;
    }
    ...
    public void initData() {
        ...
        //这个类用来防止曲线上所有的点,是点的集合,根据这些点画出曲线
        ...
        //一下都是曲线的样式和属性,renderer相当于一个用来给图表做渲染的句柄
...
//			addY=250;
            ...
            if(gx<200){
                if(hua[20]>1){
                    Toast.makeText(HeartBomActivity.this, "请用您的指尖盖住摄像头镜头！", Toast.LENGTH_SHORT).show();
                    hua[20]=0;}
                hua[20]++;
                return;}
            else
