...
import com.rilin.lzy.mybase.bean.Group;
import com.rilin.lzy.mybase.bean.People;
import com.rilin.lzy.mybase.widgets.PinnedHeaderExpandableListView;
import com.rilin.lzy.mybase.widgets.StickyLayout;

import java.util.ArrayList;
import java.util.List;

public class PinnerListViewActivity extends BaseActivity implements
    ...
    public int setViewId() {
        return R.layout.activity_pinner_list_view;
    }

    @Override
    public void initView() {
        expandableListView = getView(R.id.expandablelist);
        stickyLayout = getView(R.id.sticky_layout);
        initData();
            ...
            if (convertView == null) {
                ...
                button.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Toast.makeText(PinnerListViewActivity.this, "clicked pos=", Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    public boolean onChildClick(ExpandableListView parent, View v,
        ...
        Toast.makeText(PinnerListViewActivity.this,
