 ...
 */
public class WheelNewView extends View {
	/** Scrolling duration */
	...
	private List<OnWheelScrollNewListener> scrollingListeners = new LinkedList<OnWheelScrollNewListener>();

	/**
	 * Constructor
	 */
	public WheelNewView(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 * @param listener the listener 
	 */
	public void addScrollingListener(OnWheelScrollNewListener listener) {
	 ...
	 * @param listener the listener
	 */
	public void removeScrollingListener(OnWheelScrollNewListener listener) {
	...
	protected void notifyScrollingListenersAboutStart() {
		for (OnWheelScrollNewListener listener : scrollingListeners) {
